				...
				<div class="col-md-6">
					<div class="row" id="myText" style="background: transparent;">
						<div class="col-md-12">
							...
							<div class="p-2 mb-2 text-left" style="width: 80%; font-size: 12px; background: rgba(0, 0, 0, 0.4); border-radius: 10px; border:1px solid blueviolet; color: whitesmoke; box-shadow: 0px 1px 3px 0px red;"><span class="text-primary font-weight-bold"><i class="fa fa-user"></i> @Mr_Robot:<br></span> TF! is that? Text me ukiamua kukua dem<br>
								<video autoplay loop src="assets/video/one.mp4" muted></video>
								<span class="float-left mb-2" style="font-size: 10px; font-family: cursive;">12/19/2023</span> <br><br>
							</div>

							<div class="p-2 mb-2 text-right" style="width: 80%; margin-left: 60px; font-size: 12px; background: rgba(0, 0, 0, 0.3); border-radius: 10px; border:1px solid red; color: whitesmoke; box-shadow: 0px 1px 3px 0px blueviolet;">
								<span class="text-success font-weight-bold"> me <i class="fa fa-user-o"></i>
								<span class="float-left mb-2" style="font-size: 10px; font-family: cursive;">12/19/2023</span> <br>
								</span> Rada(:(:<br>
					           <div class="wave" data-path="assets/audio/911.mp3" style="height: auto">
							...
							<div class="p-2 mb-2 text-right" style="width: 80%; margin-left: 60px;"><iframe width="100%" height="auto" src="https://www.youtube.com/embed/-xvqoVJNyms?controls=0&amp;clip=Ugkxd9Svl1EyUGsnxA1uTZlWjisexwe9YRba&amp;clipt=EIi_ARjBkgM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style="box-shadow: 0px 1px 3px 0px blueviolet; border: 1px solid red; border-radius: 18px;" allowfullscreen=""></iframe>
							</div>
						</div>
					</div>
					<div class="row fixed-bottom p-2" style="background: rgba(0, 0, 0, 0.4);">
						<div class="col-12">
							<table width="100%">
								<tr>
									<td>
										<textarea name="message" class="" placeholder="Comment Here!" autocomplete="off" onwaiting="width: 20%;" style="background-color: rgba(0, 0, 0, 0.5); color: white; border: 1px solid whitesmoke; border-radius: 12px; height: 50px; width: 100%">	
										</textarea>
									</td>
									<td>
...
$('.wave').each(function(){
    //Generate unic ud
    var id = '_' + Math.random().toString(16).substr(2, 2);
